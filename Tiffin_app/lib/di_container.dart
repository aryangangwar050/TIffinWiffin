...
import 'data/repository/verify_pinocde_repo.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => PincodeVerifyRepo(dioClient: sl()));
  ...
  sl.registerFactory(() => PincodeVerifyProvider(verify: sl()));
