...
class DailyItemView extends StatelessWidget {
      ...
      return productProvider.dailyItemList != null
          ? Column(children: [
              ...
              ResponsiveHelper.isDesktop(context)
                  ? GridView.builder(
                      itemCount: productProvider.dailyItemList.length >= 10
                          ? 10
                      ...
                      itemBuilder: (context, index) {
                        return WebDailyItemView(
                            productProvider: productProvider, index: index);
                      },
                    )
                  : SizedBox(
                      height: 190,
  ...
  Widget listViewDailyNeedItem(
      {BuildContext context, int index, ProductProvider productProvider}) {
    return Padding(
      padding: EdgeInsets.only(right: Dimensions.PADDING_SIZE_SMALL),
      child: InkWell(
        onTap: () {
          showCustomSnackBar("Working on it....", context);
          ...
          child:
            ...
            Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),
                border: Border.all(
                    width: 1, color: ColorResources.getGreyColor(context)),
              ),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(10),
