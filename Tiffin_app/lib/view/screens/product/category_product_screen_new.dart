                                          ...
                                          children: [
                                            ...
                                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              ...
                                              Text('${cartProvider.cartList.length} ${getTranslated('items', context)}',
                                                  style: cerebriMedium.copyWith(color: Theme.of(context).cardColor)),
                                            ...
                                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              ...
                                              Text('${cartProvider.amount}',
                                                style: cerebriMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).cardColor),
                                              ),
                                            ]),
