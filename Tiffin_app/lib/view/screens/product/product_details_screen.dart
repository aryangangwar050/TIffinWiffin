                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(children: [
                                  Text('${getTranslated('total_amount', context)}:', style: cerebriMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                  Text(PriceConverter.convertPrice(context, priceWithQuantity), style: cerebribold.copyWith(
