                    ...
                    builder: (context, address, child) {
                      return ResponsiveHelper.isDesktop(context)
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      //     child: Row(children: [
                                                      //       Text(getTranslated('delivery_address', context), style: cerebriMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                                      ...
                                                      //         icon: Icon(Icons.add),
                                                      //         label: Text(getTranslated('add', context), style: cerebriRegular),
                                                      //       ),
                                                      //     ]),
                                                      //   ),
                                                      ...
                                                      //                     Text(address.addressList[index].addressType, style: cerebriBold.copyWith(
                                                      ...
                                                      //                     )),
                                                      //                     Text(address.addressList[index].address, style: cerebriRegular.copyWith(
                                                      //                       color: index == order.addressIndex ? ColorResources.getTextColor(context)
                                                      //                           : ColorResources.getHintColor(context).withOpacity(.8),
                                                      ...
                                                      //                     style: cerebriRegular.copyWith(color: Colors.white, fontSize: 10),
                                                      //                   ),
                                                      //                 ),
                                                      //               ) : SizedBox(),
                                                      //             ],
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Text(
                                                                                  ...
                                                                                  style: cerebriRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: order.selectTimeSlot == index ? Colors.white : Colors.grey[500]),
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          );
                                                                    ...
                                                                    child: Column(
                                                                        children: [
                                                                          ...
                                                                          Row(
                                                                              ...
                                                                              children: [
                                                                                Text(getTranslated('subtotal', context), style: cerebriMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                                                                Text(PriceConverter.convertPrice(context, widget.amount), style: cerebriMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                                                              ]),
                                                                          SizedBox(
                                                                              height: 10),
                                                                          Row(
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  ...
                                                                                  style: cerebriRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
                                                                                ),
                                                                                Text(
                                                                          ...
                                                                          Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  ...
                                                                                  style: cerebriMedium.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE, color: Theme.of(context).primaryColor),
                                                                                ),
                                                                              ]),
                                                                        ]),
                                                                  )
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (!_selfPickup &&
                                                                          order.addressIndex ==
                                                                              -1) {
                                                                        showCustomSnackBar(
                                                                            getTranslated('select_delivery_address',
                                                                                context),
                                                                            context,
                                                                            isError:
                                                                                true);
                                                                      } else if (order.timeSlots ==
                                                                              null ||
                                                                          order.timeSlots.length ==
                                                                              0) {
                                                                        showCustomSnackBar(
                                                                            getTranslated('select_a_time',
                                                                                context),
                                                                            context,
                                                                            isError:
                                                                                true);
                                                                          ...
                                                                          order.distance ==
                                                                              -1) {
                                                                        showCustomSnackBar(
                                                                            getTranslated('delivery_fee_not_set_yet',
                                                                                context),
                                                                            context,
                                                                            isError:
                                                                                true);
                                                                          ...
                                                                          !_isDigitalPaymentActive) {
                                                                        showCustomSnackBar(
                                                                            getTranslated('payment_method_is_not_activated_please_order_later',
                                                                                context),
                                                                            context,
                                                                            isError:
                                                                                true);
                                                                        ...
                                                                        for (int index =
                                                                          ...
                                                                          Cart
                                                                            ...
                                                                            discountAmount:
                                                                                _cartList[index].discountedPrice,
                                                                            quantity:
                                                                            ...
                                                                            variant:
                                                                                '',
                                                                            // variation: [
                                                                            //   Variation(type: _cartList[index].variation != null ? _cartList[index].variation.type : null)
                                                                            // ],
                                                                          );
                                                                          carts.add(
                                                                              cart);
                                                                        ...
                                                                        order.placeOrder(
                                                                            PlaceOrderBody(
                                                                              ...
                                                                              deliveryAddressId: !_selfPickup ? Provider.of<LocationProvider>(context, listen: false).addressList[order.addressIndex].id : 0,
                          ...
                          : Column(
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL),
                                child: Text(getTranslated('receiver_details', context), style: cerebriMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                              ),
                              SizedBox(height: 10),
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL),
