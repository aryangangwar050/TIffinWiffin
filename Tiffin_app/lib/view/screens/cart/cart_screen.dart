                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                        ...
                                        Expanded(
                                          child: TextField(
                                            ...
                                            decoration: InputDecoration(
                                                ...
                                                hintStyle: cerebriRegular.copyWith(color: ColorResources.getHintColor(context)),
                                                isDense: true,
                                                filled: true,
                                            ...
                                            child: coupon.discount <= 0
                                                ? !coupon.isLoading
                                                    ? Text(
                                                        ...
                                                        style: cerebriMedium.copyWith(color: Colors.white),
                                                      )
                                ...
                                _isSelfPickupActive ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Text(getTranslated('delivery_option', context), style: cerebriMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Text(getTranslated('items_price', context), style: cerebriRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                    Text(PriceConverter.convertPrice(context, _itemPrice), style: cerebriRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                  ]),
                                  SizedBox(height: 10),

                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Text(getTranslated('tax', context), style: cerebriRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                    Text('(+) ${PriceConverter.convertPrice(context, _tax)}', style: cerebriRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                  ]),
                                  SizedBox(height: 10),

                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Text(getTranslated('discount', context), style: cerebriRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Text(getTranslated('coupon_discount', context), style: cerebriRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                    Text(
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Text(getTranslated(_kmWiseCharge ? 'subtotal' : 'total_amount', context), style: cerebriMedium.copyWith(
