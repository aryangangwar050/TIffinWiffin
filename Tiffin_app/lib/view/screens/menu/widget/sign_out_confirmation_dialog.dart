        ...
        child:  Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Padding(
              ...
              child: Text(getTranslated('want_to_sign_out', context), style: cerebribold, textAlign: TextAlign.center),
            ),
            ...
            !auth.isLoading ? Row(children: [
             ...
             Expanded(child: InkWell(
               onTap: () {
                ...
                child: Container(
                  ...
                  child: Text(getTranslated('yes', context), style: cerebribold.copyWith(color: Theme.of(context).primaryColor)),
                ),
              )),
             ...
             Expanded(child: InkWell(
                ...
                child: Container(
                  ...
                  child: Text(getTranslated('no', context), style: cerebribold.copyWith(color: Colors.white)),
                ),
              )),
